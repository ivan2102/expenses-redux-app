...
const AccountList = (  { profile: {accounts} }  ) => {
  ...
  return (
    ...
    {accounts?.length <= 0  ? 
         ...
         <Link
          to={"/add-account"}
          className="inline-flex text-center  mt-8 items-center rounded-md border border-transparent bg-orange-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
          Add New Account
        </Link>
        </div> 
         :  
    ...
    >
      <div className="container px-4 mx-auto">
        <div className="max-w-3xl mb-12">
          <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-orange-100 bg-orange-500 font-medium uppercase rounded-full shadow-sm">
            ACCOUNTS
          </span>
                ...
                <div className="flex flex-wrap items-start justify-between p-10 -mx-4">
                  ...
                  <div className="w-full lg:w-1/3 px-4 lg:text-right">
                    <Link
                      ...
                      className="inline-flex ml-auto items-center font-medium leading-6 text-orange-900 group-hover:text-green-600 transition duration-200"
                    >
