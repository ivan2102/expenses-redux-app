  ...
  return (
    <section className="bg-sky-100 py-4">
      <div className="container px-4 mx-auto">
        <div className="pt-6 bg-sky-100 overflow-hidden border border-coolGray-100 rounded-md shadow-dashboard">
          ...
          <div className="px-6 overflow-x-auto">
            <table className="w-full">
              <tbody>
                <tr className="whitespace-nowrap h-11 bg-sky-100 bg-opacity-80">
              ...
              {transactions?.map((transaction) => (  <tr className="h-18 border-b border-coolGray-100">
                  <th className="whitespace-nowrap px-4 bg-sky-100 text-left">
                  ...
                  <th className="whitespace-nowrap px-4 bg-sky-100 text-sm font-medium text-coolGray-800 text-center">
                    {transaction?.notes}
                  </th>
                  <th className="whitespace-nowrap px-4 bg-sky-100 text-sm font-medium text-coolGray-800 text-center">
                    { transaction?.transactionType }
                  </th>
                  <th className="whitespace-nowrap px-4 bg-sky-100 text-sm font-medium text-green-500 text-center">
                    ${transaction?.amount}
                  </th>
                  <th className="whitespace-nowrap px-4 bg-sky-100 text-sm font-medium  text-center">
                  ...
                  <Link
                    ...
                    className="whitespace-nowrap cursor-pointer px-4  text-md font-medium text-blue-500 text-center"
                  >
                   <FiEdit />
                  </Link>
                </tr>))}
